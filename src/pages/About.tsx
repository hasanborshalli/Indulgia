            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-700 mb-6">
                            Born from a passion for artisanal craftsmanship and
                            pure ingredients, Indulgia brings you hand-crafted
                            chocolates that blend elegance, flavor, and emotion
                            in every piece.
                        </p>
                        <p className="text-lg text-gray-700 mb-6">
                            Each creation is made in small batches to ensure
                            quality, care, and consistency — because every bite
                            deserves attention. Whether shared with loved ones
                            or enjoyed in a quiet moment, Indulgia invites you
                            to savor the bliss of true indulgence.
                        </p>
                    </motion.div>
                    <motion.div
                        initial={{
